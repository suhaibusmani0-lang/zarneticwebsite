...
function buildTransformer(param) {
    let { split, types } = param;
 ...
 */ const convertToZero = (value, splitBefore)=>{
    if (typeof value === "number") {
        return (splitBefore === null || splitBefore === void 0 ? void 0 : splitBefore.trim().endsWith("/")) ? value : 0;
    }
...
const positionalValues = {
    // Dimensions
    width: (param, param1)=>{
        let { x } = param, { paddingLeft = "0", paddingRight = "0", boxSizing } = param1;
        const width = x.max - x.min;
        return boxSizing === "border-box" ? width : width - parseFloat(paddingLeft) - parseFloat(paddingRight);
    },
    height: (param, param1)=>{
        let { y } = param, { paddingTop = "0", paddingBottom = "0", boxSizing } = param1;
 ...
 */ __turbopack_context__.s({
    "cornerRadiusProps": ()=>cornerRadiusProps
});
 ...
 */ function applyTreeDeltas(box, treeScale, treePath) {
    ...
    for(let i = 0; i < treeLength; i++){
        ...
        if (isSharedTransition && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$motion$2d$dom$2f$dist$2f$es$2f$projection$2f$utils$2f$has$2d$transform$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hasTransform"])(node.latestValues)) {
            var _node_layout;
            transformBox(box, node.latestValues, (_node_layout = node.layout) === null || _node_layout === void 0 ? void 0 : _node_layout.layoutBox);
        }
    }
    /**
 ...
 */ function transformBox(box, transform, sourceBox) {
    const resolveBox = sourceBox !== null && sourceBox !== void 0 ? sourceBox : box;
...
__turbopack_context__.s({
    "getGeneratorVelocity": ()=>getGeneratorVelocity
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$motion$2d$utils$2f$dist$2f$es$2f$velocity$2d$per$2d$second$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/motion-utils/dist/es/velocity-per-second.mjs [app-client] (ecmascript)");
;
...
__turbopack_context__.s({
    "hasBrowserOnlyColors": ()=>hasBrowserOnlyColors
});
...
function animateTarget(visualElement, targetAndTransition) {
    ...
    const skipAnimations = transition === null || transition === void 0 ? void 0 : transition.skipAnimations;
    if (transitionOverride) transition = transitionOverride;
    const animations = [];
    const animationTypeState = type && visualElement.animationState && visualElement.animationState.getState()[type];
    const path = transition === null || transition === void 0 ? void 0 : transition.path;
    if (path) {
...
function createAnimateFunction(visualElement) {
    return (animations)=>{
        return Promise.all(animations.map((param)=>{
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$motion$2d$dom$2f$dist$2f$es$2f$animation$2f$interfaces$2f$visual$2d$element$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["animateVisualElement"])(visualElement, animation, options);
        }));
    };
}
...
function calcRelativeAxis(target, relative, parent) {
    let anchor = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 0;
...
function calcRelativeBox(target, relative, parent, anchor) {
    calcRelativeAxis(target.x, relative.x, parent.x, anchor === null || anchor === void 0 ? void 0 : anchor.x);
    calcRelativeAxis(target.y, relative.y, parent.y, anchor === null || anchor === void 0 ? void 0 : anchor.y);
}
...
function calcRelativePosition(target, layout, parent, anchor) {
    calcRelativeAxisPosition(target.x, layout.x, parent.x, anchor === null || anchor === void 0 ? void 0 : anchor.x);
    calcRelativeAxisPosition(target.y, layout.y, parent.y, anchor === null || anchor === void 0 ? void 0 : anchor.y);
}
;
...
function buildProjectionTransform(delta, treeScale, latestTransform) {
    ...
    if (latestTransform) {
        ...
        if (pathRotation) transform += "rotate(".concat(pathRotation, "deg) ");
...
function createProjectionNode(param) {
    ...
    return class ProjectionNode {
        ...
        applyTransform(box) {
            let transformOnly = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false, output = arguments.length > 2 ? arguments[2] : void 0;
            ...
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$motion$2d$dom$2f$dist$2f$es$2f$projection$2f$utils$2f$has$2d$transform$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hasTransform"])(this.latestValues)) {
                var _this_layout;
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$motion$2d$dom$2f$dist$2f$es$2f$projection$2f$geometry$2f$delta$2d$apply$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["transformBox"])(withTransforms, this.latestValues, (_this_layout = this.layout) === null || _this_layout === void 0 ? void 0 : _this_layout.layoutBox);
            }
        ...
        setAnimationOrigin(delta) {
            let hasOnlyRelativeTargetChanged = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false, pathFn = arguments.length > 2 ? arguments[2] : void 0;
            ...
            const interpolate = pathFn === null || pathFn === void 0 ? void 0 : pathFn.interpolateProjection(delta);
            this.mixTargetDelta = (latest)=>{
                const progress = latest / 1000;
                const point = interpolate === null || interpolate === void 0 ? void 0 : interpolate(progress);
                if (point) {
...
//# sourceMappingURL=node_modules_motion-dom_dist_es_123246b3._.js.map